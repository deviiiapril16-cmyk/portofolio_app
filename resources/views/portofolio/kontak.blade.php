<section class="py-5" id="kontak" style="background-color: #fff5eb;">
  <div class="container">
    <div class="row align-items-center">
    <div class="col-12 col-md-6 text-center mb-4 mb-md-0">
      <img src="img/animasi.png" alt="Kontak Saya" class="img-fluid rounded" style="max-width: 400px;">
    </div>

    <div class="col-12 col-md-6" style="font-size: 18px;">
      <h2 class="fw-normal mb-4">Kontak</h2>
