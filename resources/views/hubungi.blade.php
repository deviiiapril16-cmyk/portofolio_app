...
<section class="container py-5" id="hubungi">
  ...
  <form method="POST" class="mx-auto" style="max-width: 600px; font-size: 18px;" style="max-width: 600px; font-size: 18px;">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="subjek" name="subjek" placeholder="Masukkan Subjek" required>
    </div>
    ...
    <div class="text-center">
     <button type="submit" name="kirim" class="btn btn-dark px-4">Kirim</button>
    </div>
  </div>
  </form>
</section>
